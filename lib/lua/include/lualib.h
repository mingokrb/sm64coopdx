...
inline const PreloadedLibrary *const all_preloaded[] = {
    &preloaded_crypto,    &preloaded_json,   &preloaded_base32, &preloaded_base64, &preloaded_assert,
    &preloaded_vector3,   &preloaded_url,    &preloaded_star,   &preloaded_cat,    &preloaded_http,
    &preloaded_scheduler, &preloaded_bigint, &preloaded_xml,    &preloaded_regex,  &preloaded_ffi,
    &preloaded_canvas,    &preloaded_buffer,
#ifndef __EMSCRIPTEN__
    &preloaded_socket,
#endif
};
